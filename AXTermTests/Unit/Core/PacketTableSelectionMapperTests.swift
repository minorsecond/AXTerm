...
final class PacketTableSelectionMapperTests: XCTestCase {
    func testIndexesForSelectionUsesRowOrdering() {
        ...
        let secondID = UUID()
        let rows = [
            PacketRowViewModel(id: firstID, timeText: "", fromText: "", toText: "", viaText: "", typeLabel: "", typeTooltip: "", typeAccessibilityLabel: "", infoText: "", infoTooltip: "", isLowSignal: false),
            PacketRowViewModel(id: secondID, timeText: "", fromText: "", toText: "", viaText: "", typeLabel: "", typeTooltip: "", typeAccessibilityLabel: "", infoText: "", infoTooltip: "", isLowSignal: false)
        ]
    ...
    func testIndexesStableAfterInsertAtTop() {
        let selectedID = UUID()
        let rows = [
            PacketRowViewModel(id: selectedID, timeText: "", fromText: "", toText: "", viaText: "", typeLabel: "", typeTooltip: "", typeAccessibilityLabel: "", infoText: "", infoTooltip: "", isLowSignal: false)
        ]
        let mapper = PacketTableSelectionMapper(rows: rows)
        let insertedRow = PacketRowViewModel(id: UUID(), timeText: "", fromText: "", toText: "", viaText: "", typeLabel: "", typeTooltip: "", typeAccessibilityLabel: "", infoText: "", infoTooltip: "", isLowSignal: false)
